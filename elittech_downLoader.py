...
#    log.debug('test debug message from downLoader')
#    log.info( 'test info message from downLoader')
#    log.warn( 'test warn message from downLoader')
#    log.error('test error message from downLoader')
